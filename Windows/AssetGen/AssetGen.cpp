...
#include <fstream>
#include <vector>
#include "../IF/lodepng.cpp"
#include "../IF/lodepng.h"
...
int main(int argc, char* argv[])
{
	...
	const char* spriteDataHeaderOutputPath = "IF/Generated/SpriteData.inc.h";
	const char* spriteTypesHeaderOutputPath = "IF/Generated/SpriteTypes.h";
